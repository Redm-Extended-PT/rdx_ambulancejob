Locales['pt'] = {
  ...
  ['heal_complete'] = 'Foste curado ~y~%s~s~',
  ...
  -- Death
  ['respawn_at_hospital'] = 'Queres dar respawn ?',
  ['yes'] = 'Sim',
  ['no'] = 'no',
  ['please_wait'] = 'Vais morrer de hemorragia em ~b~%s minutos %s segundos~s~',
  ['press_respawn'] = 'Aperte [~b~E~w~] para renascer.',
  ['respawn_fine'] = 'você pagou ~r~$%s~s~ por respawning.',
